...
{
    [TestClass]
    public class NotBuildableCommunityTest
    {
        [TestMethod]
        ...
        {
            NotBuildableCommunity community = NotBuildableCommunity.Instance;
            ...
            Assert.AreEqual(community.Type, CommunityEnum.NotBuildableCommunity);
