...
{
    internal abstract class AbstractRogueMovingState : ICatanGameState
    {
        public abstract bool IsRogueMovingState { get; }

        public abstract void Cancel(CatanContext context);
        public abstract void MoveRogue(CatanContext context, int row, int col);
